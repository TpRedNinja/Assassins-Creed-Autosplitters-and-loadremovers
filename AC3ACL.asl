...
state("ACLiberation", "ACL Steam")
{
    ...
    bool IsLoading: 0x02BDAC70, 0xBB0, 0xA28, 0x10, 0xF58; // detects if you're in the loading screen or not, 1 for is 0 for not, IGT goes on during un-skippable cutscene and cutscene isn't considered loading
